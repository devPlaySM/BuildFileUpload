    ...
    return function koreBotChat() {
        ...
        var returnFun =(function ($,KRPerfectScrollbar) {
            ...
            var helpers = {
                ...
                'formatDate': function (date) {
                    ...
                    var date = year + "-" + month + "-" + day + " " + weekName;

                    return date + " " + helpers.format24(d);
        ...
        function updateOnlineStatus() {
            ...
            var chatWindowTemplate = '<script id="chat_window_tmpl" type="text/x-jqury-tmpl"> \
                <div class="kore-chat-window droppable powergen-theme"> \
                ...
                {{if msgData.message}} \
                    <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                        ...
                        <div class="tablechartDiv {{if msgData.message[0].component.payload.table_design && msgData.message[0].component.payload.table_design == "regular"}}regular{{else}}hide{{/if}}">\
                            ...
                            {{if msgData.message[0].component.payload.elements.length > 1 && msgData.message[0].component.payload.table_design && msgData.message[0].component.payload.table_design == "regular"}}<div class="showMore">자세히 보기</div>{{/if}}\
                        </div>\
                    ...
                    <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                        ...
                        <div class="listTmplContent"> \
                            ...
                            <ul class="listTmplContentBox"> \
                                ...
                                {{if msgData.message[0].component.AlwaysShowGlobalButtons || (msgData.message[0].component.payload.elements.length > 1000 && msgData.message[0].component.payload.buttons)}}\
     ...
     var iframe = '<script id="chat_message_tmpl" type="text/x-jquery-tmpl"> \
            ...
            function startGoogleWebKitRecognization() {
                ...
                final_transcript = '';
                recognition.lang = 'ko-KR';   // 영어 : en-US
                recognition.start();
            }
